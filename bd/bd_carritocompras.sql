...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-04-2020 a las 03:27:06
...
CREATE DATABASE IF NOT EXISTS `bdcarritocompras` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci;
...
INSERT INTO `empleado` (`idEmpleado`, `Rut`, `Nombres`, `Telefono`, `Estado`, `User`) VALUES
(2, '123-4', 'Roman Riquelme', '988252459', '1', 'Jo46'),
(3, '222-2', 'Palermo Suarez', '453536458', '1', 'Em22'),
(5, '333-3', 'pepe andres', '123123', '1', 'pepe');
...
(7, 'producto 1', NULL, 'es un producto', 20500, 11),
(8, 'Producto 2', NULL, 'Este es el producto 2', 12800, 1),
(9, 'Producto 3', NULL, 'Este es el producto 3', 35900, -1),
(10, 'Producto 4', NULL, 'Este es el Producto 4', 990, -2),
(11, 'Producto 5', NULL, 'Este es el Producto 5', 45900, 2),
(12, 'Producto 6', NULL, 'Este es el producto 6', 23890, 2);
